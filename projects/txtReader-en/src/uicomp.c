...
void fatal_error(char *errmsg, int height, int statusbarenabled) {
    ...
    printMiniSingleLineCutOffUnprintables(57,top-dh,"FATAL",316-57+1,COLOR_RED,COLOR_WHITE,0);
    printMiniSingleLineCutOffUnprintables(58,top-dh,"FATAL",316-57,COLOR_RED,COLOR_WHITE,1);
...
int infobox(char *infomsg, int height, int statusbarenabled) {
    ...
    SaveVRAM_1();
    drawDialog(57,top,316,bottom);
    printMiniSingleLineCutOffUnprintables(57,top-dh,"INFO",316-57+1,COLOR_BLUE,COLOR_WHITE,0);
    printMiniSingleLineCutOffUnprintables(58,top-dh,"INFO",316-57,COLOR_BLUE,COLOR_WHITE,1);
...
void fatal_wip() {
    fatal_error("£¨Unimplemented trap£©",38,1);
}
